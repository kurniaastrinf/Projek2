  ...
  <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
         <li class="nav-item "><a href="index_user.php" class="nav-link">Home</a></li>
          ...
          <li class="nav-item active"><a href="hubungi.php" class="nav-link">Hubungi Kami</a></li>
  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-end justify-content-start">
      <div class="col-md-9 ftco-animate pb-5">
       <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="fa fa-chevron-right"></i></a></span> <span>Hubungi kami <i class="fa fa-chevron-right"></i></span></p>
...
<section class="ftco-section contact-section">
  <div class="container">
   ...
   <div class="col-md-6 col-lg-3 d-flex pt-5 ftco-animate">
     ...
     <h3 class="mb-4">Nomor Hp</h3>
     <h6 class="mb-2">WhatsApp</h6>
     <p><a href="https://api.whatsapp.com/send?phone=">081 328 353 001</a></p>
     <h6 class="mb-2">Nomor Telepon</h6>
     <p><a href="tel://1234567920">081 328 353 001</a></p>
   </div>
 </div>
 <div class="col-md-6 col-lg-3 d-flex pt-5 ftco-animate">
   <div class="align-self-stretch box text-center bg-light">
   ...
   <p><a href="mailto:info@yoursite.com">dheenavet@gmail.com</a></p>
 </div>
</div>
<div class="col-md-6 col-lg-3 d-flex pt-5 ftco-animate">
 <div class="align-self-stretch box text-center bg-light">
 ...
 <p><a href="index.html">dheenavet.com</a></p>
</div>
</div>
</div>
