...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
  <div class="container">
    <a class="navbar-brand d-flex align-items-center" href="index.html"><span class="flaticon flaticon-stethoscope"></span><h1>DHEE-NA VET<span class="mini">Pets Care</span></h1></a>
  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-end justify-content-start">
      <div class="col-md-9 ftco-animate pb-5">
       ...
       <h1 class="mb-3 bread">Isi Blog</h1>
     </div>
   </div>
 </div>
</section>
...
{
$ambil_data = mysqli_query($koneksi, "select * from blog where id='$_GET[id]'");
...
<div class="paragraphs">
  <div class="row">
    <div class="span12 well">
      <img class="img-polaroid" src="images/<?=$hasil_data['gambar'];?>" style="width:350px; height: 300px; float:left; margin-right:10px;"/>
      <div class="content-heading"><h3><?=$hasil_data['judul'];?></h3></div>
      <p><a href="#" class="btn btn-inverse">Dipostkan pada <?=$hasil_data['tgl'];?></a> </p>
      ...
      <div class="col-lg-2 col-md-6">
        <div class="ftco-footer-widget">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href='pelayanan.html'><span class="fa fa-chevron-right mr-2"></span>Pelayanan</a></li>
            <li><a href="profil.html"><span class="fa fa-chevron-right mr-2"></span>Profile</a></li>
            ...
            <li><a href="tentang kami.html"><span class="fa fa-chevron-right mr-2"></span>Tentang Kami</a></li>
